 ...
 */
export declare abstract class RecaptchaV2EnterpriseRequestBase extends CaptchaRequestBase {
    /**
     ...
     */
    userAgent?: string;
    constructor({ type, nocache, websiteURL, websiteKey, enterprisePayload, recaptchaDataSValue, userAgent, }: RecaptchaV2EnterpriseRequestBaseIn);
}
